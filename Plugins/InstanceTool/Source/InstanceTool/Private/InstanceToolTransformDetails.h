 ...
 */
class FInstanceToolTransformDetails : public TSharedFromThis<FInstanceToolTransformDetails>, public IDetailCustomNodeBuilder, public TNumericUnitTypeInterface<float>
{
public:
	FInstanceToolTransformDetails( const TArray< TWeakObjectPtr<UObject> >& InSelectedObjects, class IDetailLayoutBuilder& DetailBuilder );

	/**
	 * Caches the representation of the instance transform for the user input boxes                   
	 */
	void CacheTransform();

	virtual void GenerateHeaderRowContent( class FDetailWidgetRow& NodeRow ) override {}
	virtual void GenerateChildContent( class IDetailChildrenBuilder& ChildrenBuilder ) override;
