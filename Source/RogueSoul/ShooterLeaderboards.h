 ...
 */
class ROGUESOUL_API FShooterAllTimeMatchResultsRead : public FOnlineLeaderboardRead
{
public:
 ...
 */
class ROGUESOUL_API FShooterAllTimeMatchResultsWrite : public FOnlineLeaderboardWrite
{
public:
